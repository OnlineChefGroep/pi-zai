...
import { listConfiguredGroups, resolveExistingToolNames, resolveGroupTools, } from "./groups.js";
import { LOADER_TOOL_NAME } from "./types.js";
const LOADER_PARAMS = Type.Object({
    group: Type.String({
        description: "Configured tool group name to activate additively for this session",
    }),
});
export function registerAdaptiveLoaderTool(pi, getConfig) {
    pi.registerTool({
        name: LOADER_TOOL_NAME,
        label: "Z.AI Load Tools",
        description: "Activate a configured Z.AI tool group for the rest of this session. Use only group names from configuration.",
...
//# sourceMappingURL=loader-tool.js.map