...
export default function piZaiExtension(pi) {
    ...
    pi.on("session_start", async (event, ctx) => {
        ...
        if (ctx.model)
            clampThinkingForModel(pi, ctx.model);
