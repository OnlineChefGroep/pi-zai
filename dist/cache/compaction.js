...
export function getCompactionHookOptions() {
    return {
...
export function stripHiddenReasoningFromMessages(messages) {
...
export function compactionDropsHiddenReasoning(messages) {
...
export function compactionPreservesVisibleOutcomes(messages) {
    for (const message of messages) {
        if (message.role === "assistant" && Array.isArray(message.content)) {
